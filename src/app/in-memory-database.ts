...
export class InMemoryDatabase implements InMemoryDbService {
  createDb(){
    ...
    const entries: Entry[] = [
      ...
      { id: 3, name: 'Salário na Empresa X', categoryId: categories[2].id, category: categories[23], paid: true, date: "15/10/2018", amount: "4405,49", type: "revenue" } as Entry,
      ...
      { id: 56, name: 'Cinema', categoryId: categories[1].id, category: categories[1], paid: false, date: "14/01/2021", amount: "890,00", type: "expense" }  as Entry,
      { id: 57, name: 'Piscina', categoryId: categories[1].id, category: categories[1], paid: false, date: "14/01/2021", amount: "130,00", type: "expense" }  as Entry,
      { id: 58, name: 'Agricola', categoryId: categories[1].id, category: categories[1], paid: true, date: "14/01/2021", amount: "452,00", type: "expense" }  as Entry,
      { id: 59, name: 'Mercado', categoryId: categories[1].id, category: categories[1], paid: false, date: "14/01/2021", amount: "78,00", type: "revenue" }  as Entry,
      { id: 60, name: 'Mercado', categoryId: categories[1].id, category: categories[1], paid: false, date: "14/01/2021", amount: "2598,15", type: "revenue" }  as Entry
    ]
